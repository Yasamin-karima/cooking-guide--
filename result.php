...
<h1 class="text-center color-green">غذایی که میتونی درست کنی</h1>
...
$recommendations = [
  '1,1,1,1' => [
      ...
      'image' => './food/sabzi-polo-mahi.jpg',
      'link' => 'https://irancook.com/recipes/tarze-tahaye-sabzi-polo-mahi/',
  ],
  '1,1,1,2' => [
    'name' => 'سبزی پلو با ماهیچه',
    'image' => './food/sabzi-polp-mahiche.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-sabzi-polo-mahiche/',
  ],
  '1,1,2,1' => [
      'name' => 'عدس پلو',
      'image' => './food/adas-polo-darbari.jpg',
      'link' => 'https://irancook.com/?s=%D8%B9%D8%AF%D8%B3+%D9%BE%D9%84%D9%88',
  ],
  '1,1,2,2' => [
    'name' => 'لوبیا پلو',
    'image' => './food/loobia-polo.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-loobia-polo/',
  ],
  '1,2,1,1' => [
    'name' => 'جوجه کباب',
    'image' => './food/joooje.jpg',
    'link' => 'https://parsiday.com/554-chicken-kebab/',
  ],
  '1,2,1,2' => [
    'name' => 'کباب کوبیده',
    'image' => './food/koobide.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-kabab-kobide/',
  ],
  '1,2,2,1' => [
    'name' => 'قلیه ماهی',
    'image' => './food/qalye-mahi.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-ghaliyeh-mahi/',
  ],
  '1,2,2,2' => [
    'name' => 'فسنجون',
    'image' => './food/khoresh-fesenjan.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-fesenjan-morgh/',
  ],
  '2,1,1,1' => [
    'name' => 'کوکوسبزی',
    'image' => './food/kookoo-sabzi.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-koko-sabzi/',
  ],
  '2,1,1,2' => [
    'name' => 'ساندویچ الویه',
    'image' => './food/salad-oloviye.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-salad-olvie/',
  ],
  '2,1,2,1' => [
    'name' => 'کتلت مرغ',
    'image' => './food/kotlet-morgh.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-kotlet-morgh/',
  ],
  '2,1,2,2' => [
    'name' => 'کتلت گوشت',
    'image' => './food/kotlet-goosht.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-kotlet-sade/',
  ],
  '2,2,1,1' => [
    'name' => 'ترش تره',
    'image' => './food/torsh-tare.jpg',
    'link' => 'https://namnak.com/%D8%AA%D8%B1%D8%B4-%D8%AA%D8%B1%D9%87-%DA%AF%DB%8C%D9%84%D8%A7%D9%86%DB%8C.p16805',
  ],
  '2,2,1,2' => [
    'name' => 'سوپ مرغ',
    'image' => './food/soup-morgh.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-suop-morgh-italyaee/',
  ],
  '2,2,2,1' => [
    'name' => 'خوراک لوبیا',
    'image' => './food/korak-lobia.jpg',
    'link' => 'https://www.delpazi.com/%d8%b7%d8%b1%d8%b2-%d8%aa%d9%87%db%8c%d9%87-%d8%ae%d9%88%d8%b1%d8%a7%da%a9-%d9%84%d9%88%d8%a8%db%8c%d8%a7/',
  ],
  '2,2,2,2' => [
    'name' => 'حلیم',
    'image' => './food/halim-gandom.jpg',
    'link' => 'https://irancook.com/recipes/tarze-tahaye-halim-gandom/',
  ],
];
?>
<div class="flex flex-col items-center gap-1 p-1 center">
    <div class="flex items-center gap-1">
        <div class="color-green text-2em font-bold">
            <?php
                echo $recommendations[implode(",",$_SESSION['updatedArray'])]['name'];
            ?>
        </div>
    ...
    <a href="<?php echo $recommendations[implode(",",$_SESSION['updatedArray'])]['link']; ?>" target="blank">
        <img class="flex" src="<?php echo $recommendations[implode(",",$_SESSION['updatedArray'])]['image']; ?>">
    </a>
  ...
  <div class="flex-row">
      ...
      <li class="icon-content">
        <a
          ...
          href="https://www.pinterest.com/search/pins/?q=%D8%BA%D8%B0%D8%A7%DB%8C%20%D8%A7%DB%8C%D8%B1%D8%A7%D9%86%DB%8C&rs=typed"
          target="blank"
        >
          <div class="filled"></div>
      ...
      <li class="icon-content">
        ...
        <div class="tooltip">IranCook</div>
      </li>
      <li class="icon-content">
        <a
